#!/usr/bin/env python3
"""
cards.py - render the GitHub statistics card as SVGs. Stdlib only.
...
These are files in your own repo, so they render as long as GitHub renders.
    ...
    python scripts/cards.py --user Sungho-pk42ac --out assets

Writes <out>/card-stats-{dark,light}.svg. Project cards are intentionally not
generated because this profile does not include a selected-work section.
